...
/*
  the brute force:
	convert two nums to bin, then start from back comparing  until end of smallest.
	flip means-> if 0 make it 1 else make it 1.
   we can flip with XOR operator.
  1010 ^ 0111 = 1101
  011 ^ 100 = 111
 since 0^1 = 1 and 1^0 = 1 we can aXORb and count set bits, and this is our answer.
*/
